...
<div class="card mt-n3">
    ...
    <div class="card-body mb--4">
        ...
        <div class="progress-wrapper">
            ...
            <div class="progress">
              <div class="progress-bar bg-primary" role="progressbar" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100" style="width: {{  ($item->status == "Disetujui" ? $item->status == "Dalam Perjalanan Menemui Penyewa" ? $item->status == "Sudah Menemui Penyewa" ? $item->status == "Dalam Sewa" ? $item->status == "Selesai" ? '100' : '77' : '54' : '28' : '8' : '8') }}%;"></div>
            </div>
        </div>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <strong class="display-5 d-block mx-auto">Gambar Mobil</strong>
