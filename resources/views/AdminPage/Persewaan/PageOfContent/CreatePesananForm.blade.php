...
<form id="DenganSupirForm" class="card" method="POST" action="{{ route('admin.Persewaan.cari') }}">
    @csrf
...
<form id="TanpaSupirForm" class="card d-none" method="POST" action="{{ route('admin.Persewaan.cari') }}">
    @csrf
