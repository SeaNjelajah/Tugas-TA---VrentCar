                  ...
                  <div class="float-left w-50">
                      <div class="form-group">
                          <figure class="figure text-center">
                              <img id="Preview" src="{{ asset('assets/img/users/NoUserPic.png') }}" class="figure-img img-fluid rounded border" alt="Foto Profil">                                        
                              <input class="form-control" name="gambar" type="file" set="preview" to="#Preview">                                                            
                          </figure>
                      </div>
                  </div>
