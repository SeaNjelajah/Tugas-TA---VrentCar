        ...
        <div class="container-fluid">
            ...
            <div class="row">
                    ...
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush hover">
                            <li class="list-group-item">
                                <a class="card-link" href="{{ "#" }}">My Profile</a>
                            </li>
                            <li class="list-group-item">
                ...
                <div class="col">
                    ...
                    @foreach (Auth::user()->order()->where('status', 'Baru')->get() as $order)
                    ...
                    <span class="w-100 px-auto">Berjalan</span>
                    <hr class="pl-3 mt-n1">

                    @foreach (Auth::user()->order()->where('status', 'Dalam Persewaan')->get() as $order)
